namespace rec FablePodiosuite.Types
...
type SetupsTags = Map<string, obj>
...
type PostAssetsPayload =
    ...
    static member Create (accountId: string, iccid: string, carriers: obj): PostAssetsPayload =
        { accountId = accountId
          iccid = iccid
          carriers = carriers
          name = None
